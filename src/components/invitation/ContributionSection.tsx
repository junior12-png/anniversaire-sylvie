 ...
 * ✅ Cards redesignées avec meilleure esthétique
 * ✅ Carte Orange Money "Le plus beau cadeau" revue
    ...
    >
      ...
      <motion.div
        ...
        style={{
          ...
          background: `linear-gradient(135deg, ${accentColor}55, transparent 50%, ${accentColor}33)`,
          filter: "blur(8px)",
        }}
      />
      ...
      <div style={{
        background: hovered
          ? "linear-gradient(145deg, #231908, #1a1203, #1f1605)"
          : "linear-gradient(145deg, #161204, #0c0901, #121002)",
        ...
        {/* Shimmer sweep */}
        <motion.div
          animate={hovered ? { x: ["-160%", "160%"] } : { x: "-160%" }}
          transition={hovered ? { duration: 0.9, ease: "easeInOut" } : {}}
          style={{
            position: "absolute", top: 0, left: 0, width: "60%", height: "100%",
            background: "linear-gradient(90deg, transparent, rgba(255,250,180,0.15), rgba(255,255,255,0.2), rgba(255,250,180,0.15), transparent)",
            transform: "skewX(-14deg)", pointerEvents: "none", zIndex: 2,
          }}
        />
        ...
        <div style={{
          ...
          background: `linear-gradient(90deg, transparent, ${hovered ? accentColor : `${accentColor}55`}, transparent)`,
        ...
        {[
          ...
          <div key={i} style={{
            ...
            borderStyle: "solid",
            borderColor: hovered ? `${accentColor}55` : "rgba(212,175,55,0.15)",
        ...
        <motion.div
          ...
          style={{
            ...
            borderRadius: "50%",
            background: hovered
              ? `radial-gradient(circle, ${accentColor}25, rgba(0,0,0,0.3))`
              : "rgba(212,175,55,0.06)",
            border: `1px solid ${hovered ? `${accentColor}60` : "rgba(212,175,55,0.18)"}`,
        ...
        <p style={{
          ...
          fontStyle: "italic",
          color: hovered ? "rgba(255,255,255,0.8)" : "rgba(255,255,255,0.38)",
          lineHeight: 1.65,
...
const CARDS = [
  ...
  },
  {
    ...
    desc: "Un geste de générosité pour contribuer à la magie de ce jour béni.",
    accentColor: "#c0a8e8",
  },
];
...
const OrangeMoneyCard = ({ isInView }: { isInView: boolean }) => {
  ...
  return (
    <motion.div
      ...
      style={{
        maxWidth: "clamp(280px, 80vw, 520px)",
        margin: "0 auto",
        position: "relative",
      }}
    >
      ...
      <motion.div
        ...
        style={{
          position: "absolute", inset: -4, borderRadius: 28, zIndex: -1,
          background: "linear-gradient(135deg, rgba(255,102,0,0.2), rgba(212,175,55,0.25), rgba(255,102,0,0.15))",
          filter: "blur(12px)",
          pointerEvents: "none",
        }}
      />
      ...
      <div style={{
        background: "linear-gradient(145deg, #1e0d02, #120700, #1a0a00)",
        ...
        <motion.div
          ...
          style={{
            ...
            background: "linear-gradient(90deg, transparent, rgba(255,120,0,0.07), transparent)",
            pointerEvents: "none",
          }}
        />

        {/* Gold+Orange top border */}
        <div style={{
          position: "absolute", top: 0, left: "12%", right: "12%", height: 2,
          background: "linear-gradient(90deg, transparent, rgba(255,102,0,0.7), rgba(212,175,55,0.6), rgba(255,102,0,0.7), transparent)",
        }} />
        ...
        <div style={{ position: "relative", zIndex: 1, marginBottom: "clamp(1rem, 2.5vw, 1.5rem)" }}>
          <motion.div
            ...
            style={{
              ...
              borderRadius: "50%",
              margin: "0 auto",
              background: "radial-gradient(circle, rgba(255,102,0,0.2), rgba(255,80,0,0.08))",
        ...
        <div style={{
          height: 1,
          background: "linear-gradient(90deg, transparent, rgba(255,102,0,0.3), rgba(212,175,55,0.2), rgba(255,102,0,0.3), transparent)",
          marginBottom: "clamp(1rem, 2.5vw, 1.5rem)",
          position: "relative", zIndex: 1,
        }} />
          ...
          <motion.button
            ...
            style={{
              ...
              background: copied
                ...
                : "linear-gradient(135deg, rgba(255,102,0,0.15), rgba(255,80,0,0.08))",
              border: `1.5px solid ${copied ? "rgba(212,175,55,0.5)" : "rgba(255,102,0,0.35)"}`,
              borderRadius: 100,
        ...
        <p style={{
          ...
          "Votre générosité contribue à la magie de ce jour béni."
        </p>
      </div>
    </motion.div>
  );
    ...
    <section ref={ref} style={{
      ...
      {[...Array(6)].map((_, i) => (
        <motion.div key={i}
          ...
          style={{
            position: "absolute",
            top: `${12 + i * 15}%`, left: `${8 + i * 17}%`,
            width: "clamp(2px, 0.5vw, 3px)", height: "clamp(2px, 0.5vw, 3px)",
            borderRadius: "50%",
      ...
      <div style={{ maxWidth: "clamp(320px, 95vw, 1300px)", margin: "0 auto", padding: "0 clamp(0.75rem, 4vw, 3rem)", position: "relative", zIndex: 1 }}>
        ...
        >
          ...
          >
            <Sparkles style={{ color: "#d4af37", width: "clamp(18px, 3.5vw, 26px)", height: "clamp(18px, 3.5vw, 26px)", margin: "0 auto" }} />
          </motion.div>
        ...
        <div style={{
          display: "grid",
          gridTemplateColumns: "repeat(auto-fit, minmax(clamp(200px, 42%, 340px), 1fr))",
        ...
        >
          ...
          <p style={{
            fontFamily: "'Cormorant Garamond', serif",
            fontSize: "clamp(0.92rem, 2.2vw, 1.18rem)",
            fontStyle: "italic",

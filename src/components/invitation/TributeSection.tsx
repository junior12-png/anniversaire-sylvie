/**
 * TributeSection.tsx — OPTIMISÉ PERFORMANCE
 * - useInView once:true partout
 * - SandWriter : 6 particules au lieu de 10, throttle 80ms→100ms
 * - Shimmer CenterSlider : CSS animation au lieu de motion.div repeat
 * - BouncingText : par mot (déjà ok), once:true
 */
...
// ✅ SandWriter — 6 particules au lieu de 10, délai 100ms au lieu de 80ms
const SandWriter = ({ text, fontSize = "1.05rem", color = "#f8e6a5", delay = 0 }: {
  ...
  useEffect(() => {
    ...
    const ms = count === 0 ? delay : 100; // ✅ 100ms au lieu de 80ms
    const t = setTimeout(() => {
...
// ✅ BouncingText — unchanged but will use once:true in parent
...
// ✅ once:true — ne re-anime pas au scroll retour
const LeftLetterPanel = () => {
  ...
  return (
    <motion.div
      ...
      style={{ background: "linear-gradient(145deg, rgba(28,18,4,0.95), rgba(15,9,2,0.98))", border: "1px solid rgba(212,175,55,0.18)", borderRadius: 18, padding: "clamp(1.2rem, 3vw, 2rem)", display: "flex", flexDirection: "column", gap: 14, position: "relative", overflow: "hidden", width: "100%", height: "100%" }}
    >
      ...
      <p style={{ fontFamily: "'Cinzel Decorative', serif", fontSize: "clamp(0.78rem, 1.8vw, 0.72rem)", color: "rgba(212,175,55,0.6)", letterSpacing: "0.3em", textTransform: "uppercase", textAlign: "center" }}>
        ✦ Avec Amour ✦
      </p>
      ...
      <div style={{ marginTop: "auto", textAlign: "right" }}>
        <span style={{ fontFamily: "'Cinzel Decorative', serif", fontSize: "1rem", color: "rgba(212,175,55,0.35)", letterSpacing: "0.2em" }}>— La Famille</span>
      </div>
    </motion.div>
  );
};
...
const RightLetterPanel = () => {
  ...
  return (
    <motion.div
      ...
      style={{ background: "linear-gradient(145deg, rgba(4,18,28,0.95), rgba(2,9,15,0.98))", border: "1px solid rgba(100,180,255,0.12)", borderRadius: 18, padding: "clamp(1.2rem, 3vw, 2rem)", display: "flex", flexDirection: "column", gap: 14, position: "relative", overflow: "hidden", width: "100%", height: "100%" }}
    >
      ...
      <div style={{ marginTop: "auto", textAlign: "left" }}>
        <span style={{ fontFamily: "'Cinzel Decorative', serif", fontSize: "1rem", color: "rgba(212,175,55,0.35)", letterSpacing: "0.2em" }}>— Avec Gratitude</span>
      </div>
    </motion.div>
  );
};
...
// ✅ Shimmer en CSS pur, plus de motion.div repeat:Infinity ici
const CenterSlider = () => {
  ...
  return (
    <div style={{ width: "100%", height: "100%", position: "relative", background: "linear-gradient(145deg, #0c0802, #060401, #0a0600)", border: "1px solid rgba(212,175,55,0.25)", borderRadius: 22, padding: "clamp(1.8rem, 4vw, 3rem) clamp(1.2rem, 3vw, 2.5rem)", overflow: "hidden", minHeight: "clamp(220px, 35vw, 320px)", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 16 }}>
      ...
      {/* ✅ CSS shimmer au lieu de motion repeat */}
      ...
      <AnimatePresence mode="wait">
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            ...
            <span style={{ fontFamily: "'Cinzel Decorative', serif", fontSize: "clamp(0.78rem, 2vw, 0.8rem)", color: slide.accent, letterSpacing: "0.35em", textTransform: "uppercase" }}>{slide.title}</span>
            <div style={{ height: 1, width: 24, backgroundColor: `${slide.accent}66` }} />
          </div>
          ...
          {slide.texts.map((t, i) => (
            <p key={i} style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "clamp(1rem, 2.5vw, 1.15rem)", color: i === 0 ? "#f8e6a5" : "rgba(212,175,55,0.7)", fontStyle: "italic", textAlign: "center", lineHeight: 1.7, letterSpacing: "0.02em", maxWidth: "clamp(260px, 60vw, 460px)" }}>{t}</p>
          ))}
  ...
  return (
    ...
    >
      <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 12, marginBottom: 16 }}>
        ...
        <span style={{ fontSize: "clamp(0.95rem, 2.5vw, 1.2rem)", color: "#d4af37" }}>✦</span>
      ...
      <h2 style={{ fontFamily: "'Cinzel Decorative', serif", fontSize: "clamp(1.2rem, 4.5vw, 2.8rem)", color: "transparent", background: "linear-gradient(135deg, #bf953f, #fcf6ba, #b38728, #fbf5b7, #aa771c)", WebkitBackgroundClip: "text", backgroundClip: "text", WebkitTextFillColor: "transparent", letterSpacing: "0.08em", marginBottom: 12 }}>
      ...
      <motion.p
        ...
        style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "clamp(0.9rem, 2.5vw, 1rem)", color: "rgba(212,175,55,0.55)", fontStyle: "italic", letterSpacing: "0.2em", textTransform: "uppercase", marginTop: 10 }}
      >
...
const TributeSection = () => {
  ...
  return (
    <section style={{ background: "linear-gradient(180deg, #080808 0%, #0a0600 50%, #080808 100%)", color: "white", padding: "clamp(3rem, 8vw, 6rem) 0", overflow: "hidden" }}>
      <div style={{ maxWidth: "clamp(320px, 95vw, 1400px)", margin: "0 auto", padding: "0 clamp(0.75rem, 4vw, 3rem)" }}>
        ...
        <div className="tribute-layout" style={{ display: "flex", gap: "clamp(0.75rem, 2vw, 2rem)", alignItems: "stretch" }}>
